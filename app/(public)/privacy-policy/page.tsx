  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="prose prose-gray max-w-none text-sm">
        ...
        <p>English with Arik (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) respects your privacy. This policy explains how we collect and use information when you visit englishwitharik.id.</p>
        ...
        <h2>Contact</h2>
        <p>For privacy concerns, contact us at <a href="mailto:hello@englishwitharik.id">hello@englishwitharik.id</a>.</p>
      </div>
    </div>
  )
}

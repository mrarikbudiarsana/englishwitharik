...
import { CheckCircle2, Users, Trophy, ArrowRight, MessageCircle, GraduationCap } from 'lucide-react'
            ...
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-2 bg-[#08507f]/10 text-[#08507f] text-sm font-bold px-4 py-1.5 rounded-full mb-6">
                ...
                <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                  {dynamicHero.description || "At English with Arik, our General English Program helps you build fluency, confidence, and accuracy across all four skills — Speaking, Writing, Reading, and Listening."}
                </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://wa.me/628214422358?text=Hi%20Mr%20Arik,%20I'm%20interested%20in%20taking%20a%20free%20General%20English%20placement%20test!" target="_blank" rel="noopener noreferrer"

...
export default function TestInterface({
  ...
  return (
    <div className="flex flex-col h-full w-full bg-gray-50 relative min-h-0">
      {/* Fixed Top Header */}
      <div className="shrink-0 z-40 bg-white border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center shadow-sm">
        <div>
          <h1 className="font-bold text-gray-900">{template.test.title}</h1>

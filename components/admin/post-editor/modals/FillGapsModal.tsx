...
export function FillGapsModal({ isOpen, position, initialData, onClose, onInsert }: FillGapsModalProps) {
  const [form, setForm] = useState<FillGapsFormState>(defaultState)
  ...
  return (
    <ModalWrapper
      title="Insert Fill In The Gaps Block"
      description="Use one line per item. Write gaps as [[answer]]."
      position={position}
      maxWidth="max-w-2xl"
      footer={
        <>
